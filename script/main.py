...
from mvc.data import SLEEPEDF_SUBJECTS, ISRUC_SUBJECTS, SleepDataset
from mvc.data import get_training_dataset, get_evaluation_dataset
from mvc.model import SleepContrast, SleepClassifier
...
if __name__ == '__main__':
    ...
    for i in range(len(all_subjects)):
        ...
        pretrain_data, pretrain_targets = get_training_dataset(args.data_path, seq_len=args.seq_len,
        ...
        for ratio in tqdm(args.finetune_ratio):
            ...
            finetune_data, finetune_targets = get_evaluation_dataset(args.data_path,
                                                                     data_category=args.data_category,
            ...
            test_data, test_targets = get_evaluation_dataset(args.data_path,
                                                             data_category=args.data_category,
                                                             seq_len=args.seq_len,
